...
<!--                        override POST method with hidden input -->
                        <input type="hidden" name="_METHOD" value="DELETE" />
<!--                        add csrf security into form-->
...
<!--                    overiding POST method to DELETE in input hidden btn -->
                    <input type="hidden" name="_METHOD" value="DELETE" />
    ...
    <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
        ...
        in href pass http link , dont forget ,,?,, after slash-->
        ...
        <?php foreach($pageLinks as $pageNum => $query) : ?>
            ...
            <?php endforeach; ?>
<!--    dynamic classes        Current: "border-indigo-500 text-indigo-600", Default: "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"-->
